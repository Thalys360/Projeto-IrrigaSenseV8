...
## Correção da galeria — gravação escalável

Nesta versão, cada foto da galeria é gravada em seu próprio nó no Firebase.
Mover uma foto atualiza somente os campos de ordem e excluir remove somente a foto selecionada.
Isso evita reenviar todas as imagens Base64 da galeria a cada alteração.
