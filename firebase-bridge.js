...
import("./irrigation-schedule.js?v=20260821a").catch(error => {
  console.error("Falha ao carregar Irrigação Programada:", error);
});

import("./manual-countdown.js?v=20260821a").catch(error => {
  console.error("Falha ao carregar contagem regressiva manual:", error);
});

import("./visual-upgrade.js?v=20260821a").catch(error => {
